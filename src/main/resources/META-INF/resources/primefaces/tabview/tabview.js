...
PrimeFaces.widget.TabView = PrimeFaces.widget.DeferredWidget.extend({
    ...
    init: function(cfg) {
        ...
        /*
         * Start patch:
         * Added Alain Pannetier. In some rare cases, when the browser does not make the 'right'
         * decision of CSS rules, 'ui-helper-hidden' is ignored.
         * Hiding of non-visible tabs must then be explicit.
         */
        var tabContents = this.panelContainer.children('.ui-tabs-panel:visible');
